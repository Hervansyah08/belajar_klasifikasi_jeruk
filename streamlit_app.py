...
st.set_page_config(
	...
	page_icon = ":tangerine:" #untuk icon jeruk di title
)

# load ini untuk memanggil model
...
diameter = st.slider("Diameter", 4.0, 10.0, 6.5) # 4 ini nilai minimal, 10 nilai max, dan 6.5 ini nilai default nya
...
if st.button("Prediksi", type="primary"): # type=primary ini warna nya
...
st.divider()
st.caption("Dibuat dengan :tangerine: oleh **Akbar Hervansyah**")